export default function ContactComponent() {
    return (
        <div className="">
            <div className="flex lg:flex-row flex-col px-6 justify-center gap-12">
                ...
                <form className="flex flex-col lg:w-[456px]" action="https://formspree.io/f/xleqddjz" method="POST">
