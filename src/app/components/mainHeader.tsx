    ...
    return (
        <div className="flex flex-row justify-between p-3">
            <div className="flex flex-row gap-6 place-items-center font-nunito_sans font-medium text-gray-500 transition-all duration-300">
                <a className="px-6 py-1 hover:text-gray-800 transition-all duration-300" href="">About</a>
                <a className="px-6 py-1 hover:text-gray-800 transition-all duration-300" href="">Blog</a>
                <a className="px-6 py-1 hover:text-gray-800 transition-all duration-300" href="">Projects</a>
            </div>
